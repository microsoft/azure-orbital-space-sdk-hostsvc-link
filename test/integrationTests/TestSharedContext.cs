namespace Microsoft.Azure.SpaceFx.HostServices.Link.IntegrationTests;
...
public class TestSharedContext : IDisposable {
    internal static string TARGET_SVC_APP_ID = "hostsvc-link";
...
public class MessageHandler<T> : Microsoft.Azure.SpaceFx.Core.IMessageHandler<T> where T : notnull {
    ...
    private MessageHandler<MessageFormats.Common.LogMessageResponse> _messageHandler;
